package com.wellnest.realtimechart.chart.renderer;

import static com.wellnest.realtimechart.chart.chart.RealTimeVitalChart.EMPTY_DATA;
import static com.wellnest.realtimechart.chart.chart.RealTimeVitalChart.LineMode.LINEAR;
...
import com.wellnest.realtimechart.chart.dataProvider.IVitalChartDataProvider;
...
public class RealTimeVitalRenderer {
    ...
    private void drawLinear(Canvas canvas) {
        ...
        if (mChart.getChartBackgroundColor() != null) {
            ...
            backgroundDrawablePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
            EcgBackgroundDrawable drawable = (EcgBackgroundDrawable) mChart.getChartBackgroundDrawable();
//                backgroundDrawablePaint.setShader(new BitmapShader(bitmap, Shader.TileMode.REPEAT, Shader.TileMode.REPEAT));
            drawable.setBounds(0, 0, mChart.getChartWidth(), mChart.getChartHeight());
