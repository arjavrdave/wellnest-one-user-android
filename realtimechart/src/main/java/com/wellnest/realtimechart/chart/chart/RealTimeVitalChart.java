package com.wellnest.realtimechart.chart.chart;
...
import com.wellnest.realtimechart.chart.handler.RealTimeDataHandler;
import com.wellnest.realtimechart.chart.renderer.RealTimeVitalRenderer;
import com.wellnest.realtimechart.chart.thread.DrawingThread;
import com.wellnest.realtimechart.chart.util.Transformer;
import com.wellnest.realtimechart.chart.util.ViewPortHandler;
...
public class RealTimeVitalChart extends SurfaceView implements IVitalChartDataProvider, SurfaceHolder.Callback {
    ...
    public void surfaceCreated(@NonNull SurfaceHolder surfaceHolder) {
        mDrawingThread = new DrawingThread(surfaceHolder, mRealTimeVitalRenderer);
        mDrawingThread.setName("DrawingThread");
    ...
    private void settingTransformer() {
        ...
        mTransformer.initValueMatrix(0, mSpec.getVitalMinValue(),
                (float)mSpec.getOneSecondDataCount() * mSpec.getVisibleSecondRange(),
